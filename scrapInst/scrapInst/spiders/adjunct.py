...
# inst_groups = {
#     "CS : {
#         "URL" : 'https://uwaterloo.ca/applied-mathematics/department-members/adjunct-faculty',
...
class AdjunctSpider(scrapy.Spider):
    name = 'adjunct'
    ...
    start_urls = ['https://cs.uwaterloo.ca/about/people/group/54']

    def parse(self, response, abbr_inst_name, xpath):
        AdjunctProfessors = response.xpath(xpath).getall()
        AdjunctProfessors = list(map(lambda s: s.strip(), personnel))
